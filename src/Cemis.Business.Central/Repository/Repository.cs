...
namespace CEMIS.Business.Central.Repository
{
        ...
        where TObject : class
    {
        ...
        //public Repository()
        //{
        //    Context = new EnrouteContext();
        //}
        private readonly appContextCentral Context;
        private DbSet<TObject> entities;
        string errorMessage = string.Empty;
        public Repository(appContextCentral context)
        {
            Context = context;
        ...
        public virtual int Delete(List<TObject> TObject)
        {
            DbSet.RemoveRange(TObject);
            if (!shareContext)
                return Context.SaveChanges();
            return 0;
        }
