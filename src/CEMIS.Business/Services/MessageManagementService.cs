  ...
  public  class MessageManagementService : IMessageManagementService
    {
        ...
        public MessageManagementService(appContext context, IDataProtectionProvider dataProtectionProvider, ILogger<MessageManagementService> logger, IRepository<EmailTemplate> emailtemplateRepository)
        {
            _context = context;
